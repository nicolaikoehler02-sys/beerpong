  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-5 py-10">
      <header className="mb-10">
        ...
        <h1 className="mt-1 text-4xl font-bold text-sand-hell">Bierpong</h1>
        ...
        <form action={createTournamentAction} className="space-y-4">
          <div>
            ...
            <input
              ...
              name="name"
              required
              defaultValue="Bierpong Dünencamping"
              ...
              <li key={t.id}>
                <Link
                  ...
                  className="flex items-center justify-between rounded-xl border border-kante
                             bg-karte/40 px-4 py-3 hover:border-duene transition"
                >
...
function statusText(s: string): string {
  return (
    { setup: "in Vorbereitung", group: "Gruppenphase", knockout: "Endrunde", done: "beendet" }[s] ??
    s
  );
}
